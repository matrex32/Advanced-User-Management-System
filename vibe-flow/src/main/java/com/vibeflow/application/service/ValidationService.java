...
import com.vibeflow.application.exception.InputValidationError;
import com.vibeflow.application.exception.MultipleVibeFlowException;
...
public class ValidationService {
	...
	public void validate(Object object) {
		...
		if (!constraintViolations.isEmpty()) {
			...
			throw new MultipleVibeFlowException(errorMessages);
		}
	}
}
