...
import com.vibeflow.application.service.VibeFlowUserDetailsService;
...
public class WebSecurityConfiguration {
	 ...
	 */
	@Autowired
	private VibeFlowUserDetailsService userDetailsService;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(authz->authz
				.requestMatchers("/api/users/register", "/api/users/me", "/api/users/confirm", "/api/users/email-reset-password","/reset-password", "/api/users/redirect-reset-password").permitAll()
