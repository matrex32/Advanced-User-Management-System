package com.vibeflow.application.utility;
...
public class DateUtility {
	...
	public int getDaysLeftForRecovery(User user) {
		...
		int daysLeft = vibeFlowProperties.getDaysUntilDeletion() - daysSinceDeletion;
	...
	public int getDaysLeftForConfirmAccount(User user) {
		...
		int daysLeft = vibeFlowProperties.getDaysForEmailConfirmation() - daysSinceCreation;
